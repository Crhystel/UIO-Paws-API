...
return [
    ...
    */
    ...
    'allowed_origins' => explode(',', env('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://127.0.0.1:3000,http://localhost:8001,http://127.0.0.1:8001,https://lovable.dev/projects/dc67336a-fe18-47bd-a68e-ea94e66647f9?view=design')),
